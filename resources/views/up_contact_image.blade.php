...
<body style="margin-top: 40px;">
    ...
    <div style="margin-top: 120px;margin-bottom:60px;font-size:16px;">
        <div>
            ...
            <h5 class="text-center" style="margin-bottom: 20px;font-weight:bold;">{{$contact->name}}'s Contact Image</h5>
        ...
        <div class="text-center" style="margin-bottom: 20px;font-size:16px;">
            <figure class="figure"><img class="rounded-circle img-fluid figure-img" src=" {{asset('images/contact_images')}}/{{$contact->profile_image }}" width="200" height="200" style="margin-top: 20px;">
                @if($contact->profile_image =='p.png')
                 <figcaption class="figure-caption" style="font-size: 18px;color: rgb(0,0,0);margin-top: 30px;font-weight: normal;">Upload Contact Image</figcaption>
                @else
                <figcaption class="figure-caption" style="font-size: 18px;color: rgb(0,0,0);margin-top: 30px;font-weight: normal;">Update Contact Image</figcaption>
                @endif
            </figure>
        </div>
        <div class="text-center">
        <form enctype="multipart/form-data" action="{{route('upload-contact-image',$contact->id)}}"  method="POST">
        @csrf
